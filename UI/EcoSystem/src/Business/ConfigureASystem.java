...
public class ConfigureASystem {
    ...
    public static EcoSystem configure(){
        ...
        UserAccount ua= welfare.getUserAccountDirectory().createUserAccount("Admin", "Admin", employee, new SystemAdminRole());
        Beneficiary benDetails = welfare.getBeneficiaryDirectory().addBeneficiary(0, "test","test","test","test");
        Event evtDetails = welfare.getEventDirectory().addEvent(0,"test","test","test");
        return system;
    }
