...
import userinterface.Health.NurseWorkAreaPanel;
 ...
 * @author HP
 */
public class NurseRole extends HealthRole {
    ...
    public JPanel createHealthWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, HealthEnterprise enterprise, EcoSystem business) {
        return new NurseWorkAreaPanel(userProcessContainer, business, enterprise, organization, account);
    }
