...
public class ManageWelfareEmployeePanel extends javax.swing.JPanel {
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        try{
            ...
            boolean res = organization.getEmployeeDirectory().getEmployeeList().contains(name);
            if(res == true){
                 JOptionPane.showMessageDialog(null, "Please enter new value","Error",JOptionPane.ERROR_MESSAGE);
